        ...
        >
          <template #thead="table">
            <tr class="sticky top-0 left-0">
              ...
              <Th :table="table" :sortable="false" class="uppercase">permissions</Th>
          ...
          <div class="flex flex-col space-y-2 p-4">
            ...
            <div class="flex flex-col space-y-1">
              <div class="flex space-x-1">
                <label for="permissions" class="flex-none w-1/4 lowercase first-letter:capitalize">
                  permissions
                </label>

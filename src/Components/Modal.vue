...
<template>
  <Teleport to="body">
    ...
    >
      <div v-if="open" class="fixed top-0 left-0 w-full h-screen flex items-center justify-center bg-black bg-opacity-40 backdrop-blur z-30 dark:text-gray-200 transition-all">
